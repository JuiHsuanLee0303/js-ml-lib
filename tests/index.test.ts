...
describe("Pipeline Tests", () => {
  ...
  test("createPipelineAndTrain works with MinMaxScaler", () => {
    ...
    const result = createPipelineAndTrain(X, y, 0.2, "sgd", "minmax");
  ...
  test("Pipeline produces consistent results with same random seed", () => {
    ...
    const result1 = createPipelineAndTrain(X, y, 0.2, "linear", "standard", 42);
    const result2 = createPipelineAndTrain(X, y, 0.2, "linear", "standard", 42);
